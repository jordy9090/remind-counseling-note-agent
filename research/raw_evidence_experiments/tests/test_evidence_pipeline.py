...
from research.raw_evidence_experiments.schemas import (
    ...
    EvidenceEpisodeSpan,
    RetrievedEvidenceEpisode,
)
from research.raw_evidence_experiments.services import evidence_extraction, evidence_retrieval
from research.raw_evidence_experiments.services.evidence_extraction import (
    consolidate_episode_fragments,
    extract_evidence_episode_spans,
)
from research.raw_evidence_experiments.services.evidence_retrieval import (
    diversify_evidence_episodes,
    retrieve_evidence_episodes,
    span_overlap_ratio,
)
...
class EvidencePipelineTests(unittest.TestCase):
    ...
    def test_repeated_run_stability_artifact_shape(self):
        from research.raw_evidence_experiments.scripts.evaluate_simplified_scene_extraction import _evaluate_path
    ...
    def test_rpc_sql_enforces_scope_and_cosine_order(self):
        sql = (
            Path(__file__).parents[1] / "supabase" / "evidence_episode_retrieval.sql"
