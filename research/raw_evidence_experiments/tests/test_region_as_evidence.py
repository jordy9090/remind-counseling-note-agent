...
from research.raw_evidence_experiments.scripts.evaluate_region_as_evidence import TOP_K_VALUES, evaluate, evaluate_units


SOURCE = Path(__file__).parents[3] / "results" / "debug" / "raw_window_selection" / "evaluation.json"
