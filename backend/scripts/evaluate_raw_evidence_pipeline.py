...
from app.schemas.evidence import EvidenceEpisodeSpan, RetrievedEvidenceEpisode, TranscriptTurn  # noqa: E402
from app.services import evidence_extraction, evidence_retrieval, evidence_storage  # noqa: E402
from app.services.embeddings import clear_embedding_cache  # noqa: E402

DEFAULT_FIXTURE = BACKEND_DIR / "tests" / "fixtures" / "synthetic_raw_dialogue_longitudinal.json"
...
def patched_storage(local) -> Iterator[None]:
    originals = evidence_storage.storage, evidence_extraction.storage, evidence_retrieval.storage
    try:
        evidence_storage.storage = evidence_extraction.storage = evidence_retrieval.storage = local
        clear_embedding_cache()
        yield
    finally:
        evidence_storage.storage, evidence_extraction.storage, evidence_retrieval.storage = originals
        clear_embedding_cache()
