...
from app.schemas.evidence import (
    EvidenceExtractionDiagnostic, EvidenceSpanSelection, EvidenceSpanSelectionPayload,
    SelectedEvidenceSpan, StoredTranscriptTurn,
)
from app.services.evidence_storage import build_episode_source_ref, build_episode_text
    ...
    *, query_text: str, region_turns: list[StoredTranscriptTurn], selector: SpanSelector | None = None,
    ...
    for candidate_index, candidate in enumerate(candidates):
        ...
        selected.append(SelectedEvidenceSpan(
            ...
            source_ref=build_episode_source_ref(scope[2], span.start_turn_index, span.end_turn_index),
            evidence_text=build_episode_text(ordered, span.start_turn_index, span.end_turn_index),
