...
from app.schemas.evidence import EvidenceEpisode, StoredTranscriptTurn, TurnFunctionLabel, TurnFunctionLabelPayload
from app.services import evidence_turn_functions
from app.services.evidence_extraction import (
    extract_evidence_episode_spans, extract_evidence_episode_spans_direct,
)
from app.services.evidence_storage import build_episode_text
from app.services.evidence_turn_functions import (
...
class TurnFunctionExtractionTests(unittest.TestCase):
    ...
    def test_assembled_span_builds_only_exact_raw_episode_text(self):
        ...
        text = build_episode_text(turns, span.start_turn_index, span.end_turn_index)
    ...
    def test_three_run_evaluation_artifact_structure(self):
        from scripts.evaluate_turn_function_assembly import evaluate
