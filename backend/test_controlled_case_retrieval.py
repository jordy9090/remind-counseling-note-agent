...
from scripts.evaluate_case_retrieval_controlled import LocalEvaluationStorage, cosine_similarity, metrics


FIXTURE = Path(__file__).parent / "scripts" / "fixtures" / "case_retrieval_controlled_corpus.json"
